...
var privateJetMarker = L.marker([49.007554879599994, 2.590979125572063], { icon: privateJetIcon }).addTo(featureG)
    .bindPopup("<center>" + privateJetImg + "</center>");
...
var pressMarker = L.marker([52.06900684302642, -1.020452674083726], { icon: pressIcon}).addTo(featureG)
    .bindPopup("<center>" + "C'est l'heure de la conférence de presse et de nombreux sujets sont abordés, nottament le type de pneumatique à utiliser pour maximiser vos chances."+"\n"+ "Pirelli : D'après nos calculs, les pneus Medium (jaunes) seront les plus efficaces."+pressConfImg + "</center>");
...
inventoryList.addEventListener('click', function (event) {
    ...
    if (event.target.tagName === 'IMG') {
        // Tu peux maintenant traiter l'élément cliqué comme tu le souhaites
        // Par exemple, tu pourrais changer son style pour indiquer qu'il est sélectionné
